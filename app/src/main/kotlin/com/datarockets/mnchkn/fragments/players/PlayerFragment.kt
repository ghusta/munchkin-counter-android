...
class PlayerFragment : BaseFragment(), PlayerView, View.OnClickListener {
    ...
    override fun setUpComponent(appComponent: AppComponent) {
        DaggerPlayerComponent.builder().appComponent(appComponent).playerModule(PlayerModule(this)).build().inject(this)
    }
