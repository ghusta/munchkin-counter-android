...
class PlayerChartListAdapter(private val mContext: Context,
                             private val mPlayersList: ArrayList<Player>,
                             private val mType: Int) : ArrayAdapter<Player>(mContext, 0, mPlayersList) {
