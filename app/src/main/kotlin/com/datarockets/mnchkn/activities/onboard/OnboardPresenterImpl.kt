...
class OnboardPresenterImpl(private var mOnboardView: OnboardView?, private val mOnboardInteractor: OnboardInteractor) : OnboardPresenter, OnboardInteractor.OnFinishedChecking {
